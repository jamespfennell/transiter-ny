...
# source: transiter_nycsubway/gtfs/gtfs-realtime-vendorized.proto
...
FeedMessage = _reflection.GeneratedProtocolMessageType('FeedMessage', (_message.Message,), dict(
  ...
  __module__ = 'transiter_nycsubway.gtfs.gtfs_realtime_vendorized_pb2'
