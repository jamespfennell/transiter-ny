...
from . import transiter_ny_mta_alerts_gtfs_rt_base_pb2 as transiter__ny__mta__alerts__gtfs__rt__base__pb2
...
mercury_feed_header = _descriptor.FieldDescriptor(
  name='mercury_feed_header', full_name='transiter_ny_mta_alerts.mercury_feed_header', index=0,
...
mercury_alert = _descriptor.FieldDescriptor(
  name='mercury_alert', full_name='transiter_ny_mta_alerts.mercury_alert', index=1,
  number=1001, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
mercury_entity_selector = _descriptor.FieldDescriptor(
  name='mercury_entity_selector', full_name='transiter_ny_mta_alerts.mercury_entity_selector', index=2,
  number=1001, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
_MERCURYENTITYSELECTOR_PRIORITY = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_SUNDAY_SCHEDULE', index=1, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_SATURDAY_SCHEDULE', index=2, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_HOLIDAY_SERVICE', index=3, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_EXTRA_SERVICE', index=4, number=5,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_PLANNED_WORK', index=5, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_ON_OR_CLOSE', index=6, number=7,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_SLOW_SPEEDS', index=7, number=8,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_SOME_DELAYS', index=8, number=9,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_SPECIAL_EVENT', index=9, number=10,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_STATIONS_SKIPPED', index=10, number=11,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_DELAYS', index=11, number=12,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_EXPRESS_TO_LOCAL', index=12, number=13,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_SOME_REROUTES', index=13, number=14,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_LOCAL_TO_EXPRESS', index=14, number=15,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_SERVICE_CHANGE', index=15, number=16,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_TRAINS_REROUTED', index=16, number=17,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_PART_SUSPENDED', index=17, number=18,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_MULTIPLE_IMPACTS', index=18, number=19,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_SUSPENDED', index=19, number=20,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PRIORITY_BUSING', index=20, number=21,
      serialized_options=None,
      type=None),
  ],
...
_MERCURYENTITYSELECTOR_NYCTBUSPRIORITY = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_NO_SCHEDULED_SERVICE', index=0, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_SUNDAY_SCHEDULE', index=1, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_SATURDAY_SCHEDULE', index=2, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_HOLIDAY_SERVICE', index=3, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_PLANNED_DETOUR', index=4, number=5,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_EXTRA_SERVICE', index=5, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_PLANNED_WORK', index=6, number=7,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_SPECIAL_EVENT', index=7, number=11,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_DELAYS', index=8, number=13,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_DETOURS', index=9, number=16,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_SERVICE_CHANGE', index=10, number=18,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NYCT_BUS_PRIORITY_SUSPENDED', index=11, number=22,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_MERCURYFEEDHEADER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='mercury_version', full_name='transiter_ny_mta_alerts.MercuryFeedHeader.mercury_version', index=0,
...
_MERCURYALERT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='created_at', full_name='transiter_ny_mta_alerts.MercuryAlert.created_at', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='updated_at', full_name='transiter_ny_mta_alerts.MercuryAlert.updated_at', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='alert_type', full_name='transiter_ny_mta_alerts.MercuryAlert.alert_type', index=2,
...
_MERCURYENTITYSELECTOR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='sort_order', full_name='transiter_ny_mta_alerts.MercuryEntitySelector.sort_order', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
MercuryFeedHeader = _reflection.GeneratedProtocolMessageType('MercuryFeedHeader', (_message.Message,), dict(
...
MercuryAlert = _reflection.GeneratedProtocolMessageType('MercuryAlert', (_message.Message,), dict(
...
MercuryEntitySelector = _reflection.GeneratedProtocolMessageType('MercuryEntitySelector', (_message.Message,), dict(
...
transiter__ny__mta__alerts__gtfs__rt__base__pb2.FeedHeader.RegisterExtension(mercury_feed_header)
...
transiter__ny__mta__alerts__gtfs__rt__base__pb2.EntitySelector.RegisterExtension(mercury_entity_selector)
